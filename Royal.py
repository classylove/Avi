...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await idk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await idk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await idk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await idk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ydk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ydk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ydk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ydk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await hdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await hdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await hdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await hdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await adk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await adk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await adk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await adk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await bdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await bdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await bdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await bdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await cdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await cdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await cdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await cdk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ddk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ddk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ddk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ddk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await edk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await edk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await edk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await edk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await vkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await vkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await vkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await vkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await kkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await kkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await kkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await kkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await lkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await lkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await lkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await lkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await mkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await mkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await mkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await mkk(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sid(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sid(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sid(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await sid(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aan(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aan(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aan(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aan(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ake(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ake(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ake(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await ake(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eel(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eel(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eel(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eel(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await khu(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await khu(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await khu(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await khu(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            botid = telethon.utils.get_peer_id(botme)1
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
            pass
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shi(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shi(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shi(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await shi(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await yaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await yaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await yaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await yaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await dav(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await dav(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await dav(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await dav(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await raj(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await raj(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await raj(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await raj(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await put(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await put(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await put(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await put(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eag(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eag(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eag(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await eag(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await gle(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await gle(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await gle(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await gle(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wal(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wal(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wal(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await wal(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await aaa(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await boy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await boy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await boy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
            await boy(functions.channels.JoinChannelRequest(channel="@the_secret_organization"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            ...
            try:
                ...
                await event.edit("【★𝐑𝐨𝐲𝐚𝐥𝐬★】𝐁𝐢𝐨 𝐂𝐡𝐚𝐧𝐠𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲")
            except Exception as e:
...
async def spam(e):
    usage = "https://github.com/D3stroyer-xD/Royal-SpamBot"
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        yukki = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "𝗔𝗕 𝗧𝗘𝗥𝗜 𝗠𝗔𝗔 𝐂𝐇𝐎𝐃𝐄𝐍𝐆𝐄 𝐑𝐎𝐘𝐀𝐋𝐒! "
